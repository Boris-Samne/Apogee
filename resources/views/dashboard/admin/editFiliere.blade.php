...
<div class="row ">
		<div class="col-7  bg-white border border-1 offset-2">
			<h3 style="font-family:'kanit', sans-serif;" class="my-3">Editer une categorie</h3>
				...
				<form class="container" action="{{route('admin.updateFiliere', $filiere->id)}}" method="post" enctype="multipart/form-data" >
                @csrf

                @method('PUT')
					<label>Intitule </label><br>
					<input type="text" name="intituleFil" class="form-control" id="intituleFil"  value="{{$filiere->intituleFil}}"><br>

					<label>Cycle </label><br>
					<input type="text" name="cycle"  class="form-control" value="{{$filiere->cycle}}" id="cycle" ><br>
